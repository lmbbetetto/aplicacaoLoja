...
namespace aplicacaoLoja.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,telefone,endereco,cnpj")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,telefone,endereco,cnpj")] Fornecedor fornecedor)
        {
            if (id != fornecedor.id)
            {
                return NotFound();
